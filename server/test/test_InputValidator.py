...
def test_checkInputLength():
    ...
    assert inputValidator.checkInputLength(user) == 'email & password length ok'
    del user
    ...
    assert inputValidator.checkInputLength(user) == "email length bad"
    del user
    ...
    user = getUser('u@ol.ca', 'testemailtestemailtestemailtestemailtestemailtestusfffffffffffffff')
    assert inputValidator.checkInputLength(user) == "password length bad"
    del user

    user = getUser('u@ol.ca', 'passwor')
    assert inputValidator.checkInputLength(user) == "password length bad"
    del user
